				...
				numToCheck += increment)
		{
			 ...
			 */
			 ...
			 for(int i = 0; i<trials; i++) {
				 Document aDocument = new BasicDocument(testString);
				 aDocument.getFleschScore();
			 } 
			 endTime = System.nanoTime();
			 calTime = (endTime-startTime)/100000000.0;
			 System.out.print((calTime) + "\t");
			 startTime = System.nanoTime();
			 for(int i = 0; i<trials; i++) {
				 Document aDocument = new EfficientDocument(testString);
				 aDocument.getFleschScore();
			 } 
			 endTime = System.nanoTime();
			 calTime = (endTime-startTime)/100000000.0;
