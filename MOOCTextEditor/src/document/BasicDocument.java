...
public class BasicDocument extends Document 
{
	...
	public int getNumWords()
	{
		...
		textList = (ArrayList)this.getTokens("[a-z|A-Z]+");
	...
	public int getNumSentences()
	{
        ...
        // if you need help.
		ArrayList<String> textList = new ArrayList<>();
		textList = (ArrayList)this.getTokens("[.|?|!]+");
		if(this.getText().length()>0) {
			if(this.getText().charAt(this.getText().length()-1)>='A'&& this.getText().charAt(this.getText().length()-1)<='Z'||
					this.getText().charAt(this.getText().length()-1)>='a' &&this.getText().charAt(this.getText().length()-1)<='z') {
				textList.add("end");
			}
		}
